...
// (bijvoorbeeld kan je methoden toevoegen om de score op te halen of de score op te slaan) maar gesloten voor wijziging
// (u zou de code in dit klasse niet moeten veranderen om nieuwe functionaliteit toe te voegen).
